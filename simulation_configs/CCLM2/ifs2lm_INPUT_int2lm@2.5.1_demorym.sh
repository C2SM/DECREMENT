...
# When using int2lm@2.5.1_demorym: redefine ifs2lm_INPUT, the namelist function for ifs2lm
# Based on an older version, as here: /scratch/snx3000/leclairm/DECREMENT_scClim/user_settings
